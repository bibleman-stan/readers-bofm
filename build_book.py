...
COMPOUND_SWAPS = [
    ...
    ("set him at naught", "treated him with contempt"), ("set them at naught", "treated them with contempt"),
    ("set it at naught", "treated it with contempt"),
    ("set at naught", "treated with contempt"), ("setteth at naught", "treats with contempt"),
    # ── "hence" temporal vs spatial ──
    ("days hence", "days from now"), ("years hence", "years from now"),
    ("gone hence", "passed on"), ("Gone hence", "Passed on"),
    # ── "hiss" scorn vs summon (Isaiah "whistle" stays as fallback) ──
    ("a hiss and", "an object of scorn and"), ("a hiss,", "an object of scorn,"),
    ("hiss, nor spurn", "mock, nor spurn"),
    # ── "exceedingly" collision fixes ──
    ("more exceedingly", "even more"), ("More exceedingly", "Even more"),
    ("exceedingly rejoiced", "greatly rejoiced"),
    ("affrighted exceedingly", "terrified"), ("Affrighted exceedingly", "Terrified"),
    ("wax exceedingly", "grow very"), ("Wax exceedingly", "Grow very"),
    ("waxed exceedingly", "grew very"), ("Waxed exceedingly", "Grew very"),
    ("worn exceedingly", "badly worn"),
    ("seen exceedingly", "seen very"),
    ...
    ("Repent ye, repent ye,", "Repent, repent,"),
    ("Repent ye, repent ye!", "Repent, repent!"),
    ("O repent ye, repent ye!", "O repent, repent!"),
    ("repent ye, repent ye,", "repent, repent,"),
    ("Turn ye, turn ye", "Turn, turn"),
    ("Repent ye, repent,", "Repent, repent,"),
    ("Rejoice not thou,", "Rejoice not,"),
    ("Follow thou me", "Follow me"),
    ("Hearken unto us, and hear ye our precept", "Hearken unto us, and hear our precept"),
    # Single verb+ye/thou patterns (alphabetical)
    ("Be thou", "Be"), ("be thou", "be"),
    ("Behold ye,", "Behold,"),
    ("Bring ye", "Bring"),
    ("cast ye", "cast"),
    ("Cease ye", "Cease"),
    ("Choose ye", "Choose"),
    ("Come ye,", "Come,"), ("Come ye ", "Come "),
    ("come ye", "come"),
    ("declare ye", "declare"),
    ("Depart ye,", "Depart,"),
    ...
    ("get thou", "get"),
    ("Go ye", "Go"), ("go ye", "go"),
    ("Hear ye", "Hear"), ("hear ye", "hear"),
    ("hearken ye", "hearken"),
    ("Howl ye", "Howl"),
    ("judge ye", "judge"),
    ("Know ye not", "Do you not know"), ("Know ye not,", "Do you not know,"),
    ("Know ye that", "Know that"), ("Know ye,", "Know,"),
    ("know ye that", "know that"),
    ("Lift ye", "Lift"),
    ("look ye", "look"),
    ("pray ye", "pray"),
    ("Prepare ye", "Prepare"), ("prepare ye", "prepare"),
    ("Remember ye", "Remember"),
    ("Repent ye,", "Repent,"), ("Repent ye ", "Repent "),
    ("repent ye,", "repent,"), ("repent ye ", "repent "),
    ("say ye", "say"), ("Say ye", "Say"),
    ("see ye", "see"),
    ("seek ye", "seek"),
    ("Take thou", "Take"),
    ("turn thou", "turn"), ("turn ye", "turn"),
