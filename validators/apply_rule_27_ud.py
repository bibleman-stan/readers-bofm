...
Usage:
    python validators/apply_rule_27_ud.py                 # dry-run splits
    python validators/apply_rule_27_ud.py --apply         # write splits
    python validators/apply_rule_27_ud.py --merge         # dry-run merges
    python validators/apply_rule_27_ud.py --merge --apply # write merges

Each --apply run writes a transaction log to validators/.tx/ so changes
