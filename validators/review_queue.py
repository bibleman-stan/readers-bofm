...
Usage:
    python validators/review_queue.py
    python validators/review_queue.py --detector rule_06
    python validators/review_queue.py --out /tmp/my-queue.md
...
def build_report(
    ...
    lines: list[str] = [
        ...
        "",
        f"Generated by `validators/review_queue.py` at {generated_at}.",
