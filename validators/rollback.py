...
Usage:
    python validators/rollback.py --list                     # all tx files
    python validators/rollback.py --latest                   # newest tx
    python validators/rollback.py --tx <path-to-json>        # specific tx
"""
