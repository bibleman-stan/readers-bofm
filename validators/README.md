...
**Run:**
```bash
python3 validators/syntax/validate_line_final_tokens.py
python3 validators/syntax/validate_line_final_tokens.py --verbose
```
...
**Run:**
```bash
python3 validators/colometry/validate_rule_10_verb_do_split.py
python3 validators/colometry/validate_rule_16_aictp_dangling_that.py
python3 validators/colometry/validate_rule_17_complement_integrity.py
python3 validators/colometry/validate_rule_17_complement_integrity.py --verbose
python3 validators/colometry/validate_rule_18_fixed_idioms.py
python3 validators/colometry/validate_rule_23_date_colophon.py
```
