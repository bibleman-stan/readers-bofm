...
Usage:
    python 5-machinery/validators/parity/parity_test.py
    python 5-machinery/validators/parity/parity_test.py --rule rule_17
    python 5-machinery/validators/parity/parity_test.py --rule rule_17 --verbose
    python 5-machinery/validators/parity/parity_test.py --verbose
"""
...
# Allow running from repo root or 5-machinery/validators/parity/
