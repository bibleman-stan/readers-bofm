...
Usage:
    python3 5-machinery/validators/apply_rule_15_vocative_splits.py            # dry-run
    python3 5-machinery/validators/apply_rule_15_vocative_splits.py --apply    # actually edit
"""
