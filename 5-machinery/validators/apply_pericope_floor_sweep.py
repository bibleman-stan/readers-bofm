...
Usage:
    python3 5-machinery/validators/apply_pericope_floor_sweep.py            # dry-run
    python3 5-machinery/validators/apply_pericope_floor_sweep.py --apply    # apply
    python3 5-machinery/validators/apply_pericope_floor_sweep.py --verbose  # show each
"""
