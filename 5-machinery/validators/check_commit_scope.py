...
Usage (called from commit-msg hook):
    python3 5-machinery/validators/check_commit_scope.py <commit-msg-file>
"""
...
def _is_validator(p: str) -> bool:
    return p.startswith("5-machinery/validators/")

def _is_script(p: str) -> bool:
    return p.startswith("5-machinery/scripts/")
...
CATEGORY_ALIASES: dict[str, list[str]] = {
    ...
    "script": ["script", "5-machinery/scripts/"],
    "web": [
