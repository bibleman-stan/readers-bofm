...
Usage:
    python 5-machinery/validators/apply_compound_coord_ud.py            # dry-run
    python 5-machinery/validators/apply_compound_coord_ud.py --apply    # write merges

Each --apply run writes a transaction log to 5-machinery/validators/.tx/ for rollback:
