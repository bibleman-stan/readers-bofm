...
Usage:
    python 5-machinery/validators/apply_polysyndetic_verb_chain_ud.py            # dry-run
    python 5-machinery/validators/apply_polysyndetic_verb_chain_ud.py --apply    # write
