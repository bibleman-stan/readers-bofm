...
Approach:
  ...
  2. Resolve each reference relative to the repo root, the source file's
     directory, AND a list of likely subdirs (5-machinery/validators/colometry/, data/,
     5-machinery/scripts/, 5-machinery/colab/, etc.) -- since canon and handoffs frequently cite
...
SEARCH_SUBDIRS = [
    ...
    "3-project",
    "4-process",
    # the machinery moved under 5-machinery/ on 2026-08-08; canon and docs cite
    # these by bare filename ("validate_rule_15_vocative.py"), so each directory
    # that holds a citable script must be a resolvable root
    "5-machinery",
    "5-machinery/validators",
    "5-machinery/validators/colometry",
    "5-machinery/validators/syntax",
    "5-machinery/validators/canon",
    "5-machinery/scripts",
    "5-machinery/colab",
    "data",
    "data/text-files",
...
SKIP_PATHS = {
    ...
    "gen_2nephi.py",
    "5-machinery/colab/sister_m_pipeline.ipynb",
    "5-machinery/colab/bom_reader_voices_v1.ipynb",
    "5-machinery/colab/gen_2nephi.py",
