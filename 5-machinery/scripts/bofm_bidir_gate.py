...
Usage:
  PYTHONPATH=../atu-method .venv/Scripts/python.exe 5-machinery/scripts/bofm_bidir_gate.py --calibrate
  PYTHONPATH=../atu-method .venv/Scripts/python.exe 5-machinery/scripts/bofm_bidir_gate.py            # whole corpus
  PYTHONPATH=../atu-method .venv/Scripts/python.exe 5-machinery/scripts/bofm_bidir_gate.py enos 1 --show
"""
import re
import sys
