...
Run:
  py -3 5-machinery/scripts/audit_to_candidates.py PARALLEL_THAT_ASYMMETRY            # all (786)
  py -3 5-machinery/scripts/audit_to_candidates.py PARALLEL_THAT_ASYMMETRY --pilot    # 50 (12 known + 38 random)
"""
