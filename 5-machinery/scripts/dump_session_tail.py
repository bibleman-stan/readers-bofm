...
Usage:
    py -3 5-machinery/scripts/dump_session_tail.py <workspace> [n] [cap]
    py -3 5-machinery/scripts/dump_session_tail.py atu-method 12 4000
    py -3 5-machinery/scripts/dump_session_tail.py --list          # show known workspaces
    py -3 5-machinery/scripts/dump_session_tail.py --path <file.jsonl> [n] [cap]
