...
Usage:
  ...
  python 5-machinery/scripts/generate_audio.py --book 2nephi --dry-run

  # Generate a single chapter:
  python 5-machinery/scripts/generate_audio.py --book 2nephi --chapter 6

  # Generate a range of chapters:
  python 5-machinery/scripts/generate_audio.py --book 2nephi --chapters 6-24

  # Generate all chapters of a book:
  python 5-machinery/scripts/generate_audio.py --book jacob

  # Voice test — generate first 5 lines only:
  python 5-machinery/scripts/generate_audio.py --book jacob --test

  # Force regenerate (ignore cache):
  python 5-machinery/scripts/generate_audio.py --book jacob --chapter 1 --no-cache
"""
