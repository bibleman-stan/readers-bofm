...
Run:
  py -3 5-machinery/scripts/prune_redundant_overrides.py            # dry run, report only
  py -3 5-machinery/scripts/prune_redundant_overrides.py --apply    # prune redundant
"""
import json
import os
import re
...
def regen_book(book):
    ...
    proc = subprocess.run(
        ["py", "-3", str(REPO / "5-machinery" / "scripts" / "bofm_generate.py"), book],
