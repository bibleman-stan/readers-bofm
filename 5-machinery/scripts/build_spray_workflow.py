...
Run:
  py -3 5-machinery/scripts/build_spray_workflow.py PARALLEL_THAT_ASYMMETRY --pilot
"""
...
- BIDIRECTIONAL TEST (sole arbiter): forward grammatical closure + backward
  referential self-containment. Ellipsis-restoration from immediately-prior
...
2. Forward closure: residual has a finite verb (modal+verb "may eat" /
   ...
   satisfied; ellipsis-restoration of FINITE verb from immediate prior line
