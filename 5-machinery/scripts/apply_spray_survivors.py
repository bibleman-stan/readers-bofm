...
Run (single or multiple chunk outputs):
  py -3 5-machinery/scripts/apply_spray_survivors.py path/to/spray-output.json
  py -3 5-machinery/scripts/apply_spray_survivors.py chunk0.json chunk1.json chunk2.json
