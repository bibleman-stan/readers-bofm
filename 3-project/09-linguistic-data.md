...
This document presents quantified metrics from the Book of Mormon ATU corpus after the full mechanical scrub (178 fixes, March 2026). All data computed from the canonical v2 source files. Per-chapter data is in `data/colometric_metrics.csv`; the analysis script is `5-machinery/scripts/colometric_analysis.py`.
